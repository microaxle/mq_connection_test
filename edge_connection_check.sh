...
# ============================================================================
# Script execution starts here - no need to provide parameters via command line
# ============================================================================
...
# Step 4: Send test message if SYNC_MODE is true (before displaying summary)
test_msg_result=""
test_msg_content=""
test_msg_status=""
...
# Include test message result in summary table if SYNC_MODE is true
if [ "$SYNC_MODE" = "true" ]; then
